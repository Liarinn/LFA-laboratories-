...
class ChomskyNormalForm:
    ...
    def create_grammar(self):
        ...
        V_n = input("Input Non-Terminat terms, separated by comma: ")
        V_n = V_n.split(",")
        print(V_n)
        self.V_n = V_n
    ...
    def convert_to_Chomsky_Normal_Form(self):
        if self.type_grammar == 2:
            ...
            return ChomskyNormalForm(V_n=new_V_n, V_t=new_V_t, P=new_P, S=new_S, type=self.type_grammar)
        else:
